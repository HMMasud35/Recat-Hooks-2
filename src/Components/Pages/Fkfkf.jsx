...
const Fkfkf = () => {
  return (
    <div><section className="bg-gray-50 py-8 dark:bg-gray-900 md:py-12">
        ...
        {products.map((item) => {
          return (
            <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800">
              <div className="h-56 w-full bg-white flex justify-center rounded-md">
                <a href="#">

                  <img
                    className="mx-auto h-10/12 mt-3 dark:hidden"
                    src={item.image}
                    alt=""
                  />
                  <img
                    className="mx-auto hidden h-10/12 mt-3 dark:block"
                    src={item.image}
                    alt=""
                  />
                </a>
              ...
              <div className="pt-3">
                <div className="mb-4 flex items-center justify-between gap-4">
                  <span className="me-2 rounded bg-purple-700 px-2.5 py-0.5 text-sm font-medium text-amber-300 dark:bg-primary-900 dark:text-primary-300">
                    Product ID : 100{item.id}
                  </span>
